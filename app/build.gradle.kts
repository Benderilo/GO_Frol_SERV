...
// Данные подписи лежат в keystore.properties рядом с проектом (файл в .gitignore).
// Если файла нет — используется стандартный отладочный ключ Android Studio.
...
android {
    ...
    namespace = "com.example.frolovsistems"
    compileSdk {
        version = release(37)
    }
